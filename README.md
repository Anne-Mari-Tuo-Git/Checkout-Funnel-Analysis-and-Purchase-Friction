...
* [cite_start]**Key Focus:** Analyzing the **12,545 "Add to Cart" events** [cite: 45, 46] [cite_start]to understand the **49% friction point** before checkout [cite: 31, 59] and calculating the total financial impact using custom **DAX measures**.

 ## 🛠️ Technologies Used

Data Preparation: Excel, Power Query

Analysis & Visualization: Power BI, Power Point
